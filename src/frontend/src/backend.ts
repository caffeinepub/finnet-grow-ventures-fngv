...
import type { PayoutRequest as _PayoutRequest, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async designateIdProduct(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.designateIdProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDirectReferrals(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDirectReferrals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDownlineStructure(): Promise<{
        level1Count: bigint;
        level2Count: bigint;
        level1: Array<Principal>;
        level2: Array<Principal>;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getDownlineStructure();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEarningsDashboard(): Promise<{
        balance: bigint;
        totalEarned: bigint;
        commissionHistory: Array<Commission>;
        totalWithdrawn: bigint;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getEarningsDashboard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFixedReferralBonusSummary(): Promise<FixedReferralBonusSummary> {
        if (this.processError) {
            try {
                const result = await this.actor.getFixedReferralBonusSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getIdProducts(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getIdProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyPayoutRequests(): Promise<Array<PayoutRequest>> {
        if (this.processError) {
            try {
    ...
    async getReferralBonusHistory(): Promise<Array<ReferralBonus>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReferralBonusHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markOrderDelivered(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: bigint, arg1: bigint): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async processPayoutRequest(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.processPayoutRequest(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeIdProduct(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeIdProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestPayout(arg0: bigint): Promise<PayoutRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.requestPayout(arg0);
                return from_candid_PayoutRequest_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async updateWalletBalance(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_PayoutRequest_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PayoutRequest): PayoutRequest {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: value.status,
        processedBy: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.processedBy)),
        processedDate: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.processedDate)),
        amount: value.amount,
